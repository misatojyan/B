...
public class RegionAdapter extends VideoItemAdapter
{
    private List<VideoItem> mVideoItems;

    private LayoutInflater mInflater;

    public RegionAdapter(List<VideoItem> videoItems, LayoutInflater inflater)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = mInflater.inflate(R.layout.nico_video_item_region, null);
        ...
        Region recommend = (Region) mVideoItems.get(position);
